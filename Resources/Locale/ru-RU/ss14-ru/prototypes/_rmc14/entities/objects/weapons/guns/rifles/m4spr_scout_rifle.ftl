ent-WeaponRifleM4SPRCustom = модифицированная боевая винтовка M4RA
    .desc = Усовершенствованная версия уже отличной M4RA. Способна использовать патроны A19, имея при этом лучшую точность и управляемость, но при этом сложнее в использовании.  Также может использовать обычные магазины M4SPR с меньшим уроном.
