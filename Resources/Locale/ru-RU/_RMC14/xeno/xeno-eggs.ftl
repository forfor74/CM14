...
rmc-xeno-egg-fail-return = Это яйцо не может вместить этого лицехвата.
rmc-xeno-egg-return-start = Мы начинаем помещать лицехвата в яйцо.
rmc-xeno-egg-return-user = Мы помещаем лицехвата обратно в яйцо.
...
rmc-xeno-fragile-egg-prefix = хрупкий { $baseName }
